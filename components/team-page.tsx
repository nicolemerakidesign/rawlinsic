            ...
            <div className="team-popup-left">
              ...
              <div className="team-popup-social">
                <a
                  ...
                  aria-label="LinkedIn"
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="url(#linkedinGold)">
                    <defs><linearGradient id="linkedinGold" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#c9a84c"/><stop offset="50%" stopColor="#e8d5a0"/><stop offset="100%" stopColor="#d4b878"/></linearGradient></defs>
