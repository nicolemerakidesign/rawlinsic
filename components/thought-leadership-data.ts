...
export const THOUGHT_LEADERSHIP: ThoughtLeadershipArticle[] = [
  ...
  },
  {
    ...
    author: "Coming Soon",
    authorRole: "Rawlins Infra Consult",
    authorEmail: "info@RawlinsIC.com",
    authorPhone: "",
    date: "2026-04-01",
    ...
    content: [
      {
        type: "intro",
        text: "This article is coming soon. Check back for insights on strategic workforce planning in transportation.",
      },
    ],
  },
  {
    ...
    content: [
      {
        type: "intro",
        text: "This article is coming soon. Check back for insights on AI readiness in public agencies.",
      },
    ],
  },
];
