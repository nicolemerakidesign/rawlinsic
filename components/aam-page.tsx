        ...
        <div className="aam-container">
          <div className="aam-overview-grid">
            ...
            <div className="aam-overview-right reveal rd1">
              <div className="ls-vis-wrapper" style={{ position: 'relative' }}>
                {/* Illustrator SVG as base image */}
                <img src="/images/pages/aam-interactive-diagram.svg" alt="AAM Ecosystem Diagram" style={{ display: 'block', width: '110%', height: 'auto', marginLeft: '-5%' }} />
                {/* Invisible interactive overlay for hover tooltips */}
                <svg viewBox="0 0 1000 660" xmlns="http://www.w3.org/2000/svg" style={{ position: 'absolute', top: 0, left: '-5%', width: '110%', height: '100%', pointerEvents: 'none' }}>
                  ...
                  {/* Invisible hit areas for hover tooltips — positioned to match Illustrator SVG */}
